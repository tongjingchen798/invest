...
//    @RequiresPermissions("sys:payinfo:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
//    @RequiresPermissions("sys:payinfo:info")
    public Result<PayInfoDTO> get(@PathVariable("id") Long id){
        PayInfoDTO data = payInfoService.get(id);

        return new Result<PayInfoDTO>().ok(data);
    }

    @PostMapping
    @ApiOperation("保存")
    @LogOperation("保存")
//    @RequiresPermissions("sys:payinfo:save")
    public Result save(@RequestBody PayInfoDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, AddGroup.class, DefaultGroup.class);

        payInfoService.save(dto);
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
//    @RequiresPermissions("sys:payinfo:update")
    public Result update(@RequestBody PayInfoDTO dto){
        //效验数据
        ValidatorUtils.validateEntity(dto, UpdateGroup.class, DefaultGroup.class);

        payInfoService.update(dto);
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
//    @RequiresPermissions("sys:payinfo:delete")
